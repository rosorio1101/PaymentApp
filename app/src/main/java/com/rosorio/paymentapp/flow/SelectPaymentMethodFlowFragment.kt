 ...
 * [SelectPaymentMethodFlowFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [SelectPaymentMethodFlowFragment.newInstance] factory method to
...
class SelectPaymentMethodFlowFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            SelectPaymentMethodFlowFragment().apply {
