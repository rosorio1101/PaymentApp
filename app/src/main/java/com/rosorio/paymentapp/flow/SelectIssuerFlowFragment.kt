 ...
 * [SelectIssuerFlowFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [SelectIssuerFlowFragment.newInstance] factory method to
...
class SelectIssuerFlowFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            SelectIssuerFlowFragment().apply {
